...
secrets on the
[appropriate page](https://github.com/cisagov/guacamole-packer/settings/secrets)
...
AWS_PROFILE=cool-images-ec2amicreate-guacamole-packer packer build --timestamp-ui -var release_tag=$(./bump_version.sh show) -var is_prerelease=true src/packer.pkr.hcl
```
...
```console
AWS_PROFILE=cool-images-ec2amicreate-guacamole-packer packer build --timestamp-ui -var-file release.pkrvars.hcl src/packer.pkr.hcl
```
